...
PYTHON_FILE_NAME_IN_CHECKNEEDS_DIR="_return0.py" # The actual Python test file
...
# Paths relative to BASE_DIR (which is pwd when this script is called by runtest.sh)
BASE_DIR=$(pwd)
SCRIPT_BASENAME=$(basename "$0") # e.g., _return0.sh
