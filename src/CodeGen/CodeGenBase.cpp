...
CodeGenBase::CodeGenBase()
    : context(nullptr), module(nullptr), builder(nullptr),
      currentFunction(nullptr), currentReturnType(nullptr),
      inReturnStmt(false), savedBlock(nullptr),
      lastExprValue(nullptr), lastExprType(nullptr) {
}
