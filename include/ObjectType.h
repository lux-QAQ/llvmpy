...
protected:
    ...
    static std::unordered_map<std::string, 
                             std::unordered_map<std::string, bool>> typeFeatures;
};
...
public:
    ...
    const ObjectType* getElementType() const { return elementType; }
...
public:
    ...
    const ObjectType* getKeyType() const { return keyType; }
    const ObjectType* getValueType() const { return valueType; }
...
public:
    ...
    const ObjectType* getReturnType() const { return returnType; }
    const std::vector<ObjectType*>& getParamTypes() const { return paramTypes; }
